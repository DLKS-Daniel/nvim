...
vim.keymap.set("n", "<leader>ps", "<cmd>!prettier -w %<cr>", opts)
vim.keymap.set("n", "<leader>js", vim.lsp.buf.format, opts)
...
vim.lsp.enable({ "lua_ls", "basedpyright", "ruff", "jsonls" }) -- Installed with winget, uv, and npm
